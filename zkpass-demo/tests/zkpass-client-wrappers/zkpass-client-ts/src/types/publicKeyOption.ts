...
import { KeysetEndpointWrapped } from "./keysetEndpoint";
import { PublicKeyWrapped } from "./publicKey";

export type PublicKeyOption = PublicKeyWrapped | KeysetEndpointWrapped;
