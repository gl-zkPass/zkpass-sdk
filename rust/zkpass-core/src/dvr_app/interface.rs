...
use crate::privacy_apps::interface::{ PublicKey, PublicKeyOption, ZkPassPrivacyAppError };
...
pub enum ZkPassError {
    ...
    #[error("Missing {0} Element")] MissingElementError(String),
...
impl ZkPassPrivacyAppError for ZkPassError {}
