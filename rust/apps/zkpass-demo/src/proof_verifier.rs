...
pub mod verifier {
    ...
    use zkpass_client::interface::{
        ZkPassClient, ZkPassProofMetadataValidator, ZkPassProofVerifier, ProofVerifier
    };
    ...
    impl ProofVerifier for MyProofVerifier {}
    ...
    impl MyProofVerifier {
        ...
        pub fn get_dvr_token(&self, dvr_file: &str) -> String {
            ...
            //
            let query_engine_version_info = self.get_query_engine_version_info();
