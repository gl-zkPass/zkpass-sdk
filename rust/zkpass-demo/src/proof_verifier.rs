...
pub mod verifier {
    ...
    use zkpass_client::interface::{
        ZkPassApiKey, ZkPassClient, ZkPassProofMetadataValidator, ZkPassProofVerifier,
        ZkPassUtility,
    };
        ...
        fn get_expected_dvr(&self, dvr_id: &str) -> Result<DataVerificationRequest, ZkPassError> {
            ...
            match removed_item {
                ...
                None => {
                    ...
                    return Err(ZkPassError::MismatchedDvrId);
                }
            }
    ...
    //
    pub struct MyProofVerifier;

    impl MyProofVerifier {
        //
        ...
        pub fn get_dvr_token(&self, dvr_file: &str) -> String {
            ...
            let mut query_content =
                std::fs::File::open(dvr_file).expect("Cannot find the dvr file");
            ...
            let verifier_pubkey = issuer_pubkey.clone();
            ...
            //
            //  Step 1: Call zkpass_client.get_query_engine_version_info.
            ...
            //
            //  Step 3: Call zkpass_client.sign_data_to_jws_token.
            //          to digitally-sign the dvr data.
            //
            let dvr_token = zkpass_client
                .sign_data_to_jws_token(VERIFIER_PRIVKEY, json!(dvr.clone()), Some(ep))
                .unwrap();
