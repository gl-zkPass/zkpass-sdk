...
mod ts_exports_test {
    ...
    #[test]
    fn r0_get_query_engine_version_wrapper_test() {
    ...
    #[test]
    fn r0_get_query_method_version_wrapper_test() {
    ...
    #[ignore]
    #[test]
    fn r0_verify_zkproof_wrapper_test() {
        let decoded_proof = decode_zkproof(PROOF_CORRECT);
        let proof_ptr = decoded_proof.as_ptr() as *const i8;
        let verification_result: Response<*const c_char> = r0_verify_zkproof_wrapper(proof_ptr);
    ...
    #[test]
    fn r0_verify_zkproof_wrapper_fail_test() {
        let invalid_proof = "some_invalid_proof".as_ptr() as *const i8;
        let verification_result: Response<*const c_char> = r0_verify_zkproof_wrapper(invalid_proof);
