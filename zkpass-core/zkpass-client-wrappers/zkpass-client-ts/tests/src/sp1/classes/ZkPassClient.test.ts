...
import {
  ...
  badUserDataJwt,
  dvrJwtWithPublicKey,
} from "../../../resources/sp1/variables/zkPassClient";
import {
  publicKeyIssuer,
  privateKeyIssuer,
  privateKeyVerifier,
...
import { queryEngineResult } from "../../../resources/sp1/variables/mockResult";
import { proofToken } from "../../../resources/sp1/variables/zkProofTrue";
import { falseProofToken } from "../../../resources/sp1/variables/zkProofFalse";
import { ZKPASS_SERVICE_KEYS } from "../../../resources/zkPassServiceKeys";
import { mockFetchResponse } from "../../common/mock";
import { proofTokenStaging } from "../../../resources/sp1/variables/zkProofTrueStaging";
...
describe("ZkPassClient", () => {
  ...
  describe("verifyZkPassProof", () => {
    ...
    it("should return error if the .so file path is not found", () => {
      process.env.FFI_BINARY_PATH = "/home/invalid/path";
      expect(
        () =>
          new ZkPassClient({
