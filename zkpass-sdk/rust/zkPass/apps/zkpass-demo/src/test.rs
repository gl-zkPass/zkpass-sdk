...
mod tests {
    ...
    use hex;
    use zkpass_client::core::{ZkPassError, ZkPassProof, PublicKeyOption, PublicKey, DataVerificationRequest};
    ...
    fn test_access() {
        ...
        let pubkey2 = PublicKey{x: String::from("1234"), y: String::from("9123")};
        ...
        let pubkey = PublicKey{x: String::from("9480"), y: String::from("9232")};
        let pubkey2 = PublicKey{x: String::from("9480"), y: String::from("9232")};
